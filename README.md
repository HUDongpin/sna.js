...
- The larger statistical models (`netlm`, `netlogit`, `lnam`, `bbnam*`, `bn`, `pstar`, role/blockmodel analysis) are ported and unit-exercised but **not yet covered by the golden parity suite — treat them as experimental**.
